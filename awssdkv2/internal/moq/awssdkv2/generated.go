...
// Ensure, that MockS3API does implement awssdkv2.S3API.
// If this is not the case, regenerate this file with moq.
var _ awssdkv2.S3API = &MockS3API{}

// MockS3API is a mock implementation of awssdkv2.S3API.
//
// 	func TestSomethingThatUsesS3API(t *testing.T) {
//
// 		// make and configure a mocked awssdkv2.S3API
...
// 		}
//
// 		// use mockedS3API in code that requires awssdkv2.S3API
