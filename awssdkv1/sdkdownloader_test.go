...
import (
	...
	mock_s3manageriface "github.com/at-wat/s3iot/awssdkv1/internal/moq/s3manageriface"
...
func TestNewAWSSDKDownloader(t *testing.T) {
	...
	api := &mock_s3manageriface.MockDownloader{
		DownloadWithContextFunc: func(ctx context.Context, w io.WriterAt, input *s3.GetObjectInput, opts ...func(*s3manager.Downloader)) (int64, error) {
	...
	if n := len(api.DownloadWithContextCalls()); n != 1 {
